...
const solomonPrompt = [
  ...
  "Start warmly. Prioritize collecting:",
  "- Full Name",
  "- Email Address",
  "- Phone Number",
  "Then move onto garage goals, must-have features, square footage, budget, start date.",
  "Weave questions naturally. Avoid listing questions robotically.",
  "Be encouraging but professional.",
  "End by thanking them and explaining that the team will reach out soon."
].join("\n");
// == AI MESSAGE HANDLER ==
