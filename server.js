...
async function extractIntakeData(conversationHistory) {
  ...
  const prompt = [
    ...
    "",
    "Important: Do not reply with a greeting, commentary, or conversation. Only return a single valid JSON object with the following keys:",
    "Respond only with JSON. Do not include any text before or after the JSON. No assistant tags. No markdown.",
    "- full_name",
    "- email",
    "- phone",
    "- garage_goals",
